...
with st.sidebar:
    ...
    max_area_m2 = st.number_input("Maximum area Amax (m²)", min_value=0.1, value=184.6, step=0.1)
...
with col1:
    ...
    top_gamma = st.number_input("Top layer gamma' (kN/m³)", min_value=0.1, value=9.5, step=0.1)
...
with col2:
    ...
    low_gamma = st.number_input("Lower layer gamma' (kN/m³)", min_value=0.1, value=9.5, step=0.1)
